    ...
    >
      ...
      <div className="app-frame-no-drag flex items-center gap-2">
        ...
        <div className="flex items-center gap-1">
          <IconButton onClick={() => window.blocker.sendFrameAction('MINIMIZE')} aria-label="Minimize">
            <Minus size={15} />
          </IconButton>
          <IconButton onClick={() => window.blocker.sendFrameAction('MAXIMIZE')} aria-label="Maximize">
            <Square size={12.5} />
          </IconButton>
          <IconButton onClick={() => window.blocker.sendFrameAction('CLOSE')} aria-label="Close" danger>
            <X size={15} />
          </IconButton>
        </div>
      </div>
